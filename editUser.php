...
<meta charset="utf-8">
<!-- 
	This page displays the form used to edit the user data.
-->
<?php
    ...
    <body>
        ...
        <div id="container">
           <div id="header"><h1><img src="img/logo.png" id ="img" alt="gym" >The Powerhouse Gym  </h1><?php displaySignOut();?></div>
			...
			<h1>Update User Details</h1><?php displayTooltipInput();?><br>

				<div style = "width: 60%">
			<form action="processUserUpdate.php" onsubmit="return validateInputForm('updateForm');" name="updateForm" method = "post">
