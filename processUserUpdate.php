<?php
// Collecting the data from the user update input form and updating the database
...
// update queries
$sqlQuery = "UPDATE customer SET first_name = '$firstname',second_name='$lastname',phone_number='$number',email= '$email'
				WHERE id = '$id'";	 
$sqlQueryAdd = "UPDATE address SET address ='$address', city= '$city', zip_code = '$zip' WHERE address.id= '$id'";		
