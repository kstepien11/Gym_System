...
<meta charset="utf-8">
<!-- 
	 provides the form that allows to create new personal trainer entry in the database
-->
<?php
...
<html>
    ...
    <body>
        ...
        <div id="container">
			...
			<h1>New Personal Trainer Form</h1>   <?php displayTooltipInput();?>
			 <br>
			
				<div style = "width: 60%"> 
				<form action="processNewPT.php" onsubmit="return validateInputForm('updateForm');" name="updateForm" method = "post">
